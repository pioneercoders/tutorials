...
### 5. Which methods are used during the Serialization and Deserialization process?
...
### 6. When to use Runnable interface Vs Thread class in Java?
...
### 7.	How do you read data from a flat file in java?

Buffered Reader, Scanner, Files, FileReader

### 8.	How do you prevent someone from overriding a method in a class you write?
 
private, static and final


### 9.	What does it mean if a method or field is static?
...
### 13. Use of equals in JAVA?

The equals() method compares two strings, and returns true if the strings are equal, and false if not.

### 14. What are the two types of Exceptions in Java? Which are the differences between them?
...
### 15. What is JVM? Why is Java called the “Platform Independent Programming Language”?
